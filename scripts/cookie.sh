...
cookie_value="we12come"
signature=$(echo -n "$cookie_value" | openssl dgst -sha256 -hmac "$COOKIE_SECRET_KEY" | awk '{print $2}')
signed_cookie_value="$cookie_value.$signature" # Combine value and signature
